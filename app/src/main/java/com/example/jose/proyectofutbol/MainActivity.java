...
import com.example.jose.proyectofutbol.models.Main2Activity;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Class fragmenClass=Inicio.class;
        try {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            View aView2 = getLayoutInflater().inflate(R.layout.activity_acerca_de, null);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_gallery) {
            ...
            fragmentClass= EstadiosRusia.class;
            ...
            fragmentClass= Informacion.class;
